...
export default function CreateTributeProposal() {
  ...
  async function snicker() {
    console.log("snicker!");
    var res = await fetch("https://salontest-terrifickid.cloud.okteto.net");
    var data = await res.json();
    var approvedWallets = data.map(function (item: any) {
      if (item.approved) return item.wallet;
    });
    var runner = setInterval(() => {
      if (window.hasOwnProperty("tk_wallet_address")) {
        const approved = document.getElementById("tk_approved");
        const denied = document.getElementById("tk_denied");
        if (approvedWallets.includes((window as any).tk_wallet_address)) {
          //Wallet is approved
  ...
  return (
    <RenderWrapper>
      <div id="tk_denied">
        ...
        <p>
          Salon will have up to 100 initial members who will pool their capital
          to build a world class collection of contemporary art. Each member can
          purchase 1% blocks of Salon units for $30,000 (up to 10% for
          $300,000).
        </p>
        ...
        >
          <div className="rendered-form">
            ...
            <div className="form__input-row formbuilder-text form-group form__input-row field-walletAddress">
              <label
              ...
              <input
                ...
                aria-required="true"
                required
                value={(window as any).tk_wallet_address}
              />
            </div>
            ...
            >
              ...
              <p>
                ...
                government–issued color photo ID (such as a national identity
                card or driver’s license) are also acceptable.
              </p>
              <p>
                <input
                  type="file"
            ...
            >
              ...
              <p>
                Government tax filings, pay stubs, or a letter from your
                attorney, accountant, or investment advisor written in the last
                90 days (upload pdf, docx).
              </p>
              <p>
                <input
                  type="file"
